...
int main() {
    ...
    webSocket.setOnMessageCallback([&webSocket, &connected, &img_timestamp, &left_img, &right_img, &imu_timestamp, &accel, &gyro, timestamp_size, image_size, imu_size](const ix::WebSocketMessagePtr& msg) {
